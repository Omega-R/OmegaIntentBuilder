 ...
 */
class SupportFragmentIntentHandler(private val fragment: androidx.fragment.app.Fragment, private val createdIntent: Intent) : ContextIntentHandler(fragment.requireContext(), createdIntent) {
